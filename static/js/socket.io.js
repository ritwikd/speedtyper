...
/***/ function(module, exports) {
	...
	var parts = [
	    'source', 'protocol', 'authority', 'userInfo', '_id', 'password', 'host', 'port', 'relative', 'path', 'directory', 'file', 'query', 'anchor'
	];
...
/***/ function(module, exports, __webpack_require__) {
	...
	function formatArgs() {
	  ...
	  args[0].replace(/%[a-z%]/g, function(match) {
	    ...
	    if ('%c' === match) {
	      ...
	      // (the _id may have provided their own)
	      lastC = index;
	    }
	  });
	 ...
	 * when a _id disables cookies/localstorage
...
/***/ function(module, exports, __webpack_require__) {
	...
	function encodeAsString(obj) {
	  ...
	  // immediately followed by the s_id
	  if (null != obj.id) {
	    if (nsp) {
	      str += ',';
	      nsp = false;
	        ...
	        var serialize = function (property, object, callback, properties, whitespace, indentation, stack) {
	          ...
	          if (typeof value == "object") {
	            ...
	            if (className == arrayClass) {
	              ...
	              // either a _id-specified list of property names, or the object
	              // itself.
...
/***/ function(module, exports, __webpack_require__) {
	...
	/**
	 * Update `socket.s_id` of all sockets
	 *
	 * @api private
	 */
...
/***/ function(module, exports, __webpack_require__) {
	...
	Socket.prototype.createTransport = function (name) {
	  ...
	  // session s_id if we already have one
...
/***/ function(module, exports, __webpack_require__) {
	...
	function polling (opts) {
	  ...
	  if (global.location) {
	    ...
	    // some _id agents have empty `location.port`
	    if (!port) {
	      port = isSSL ? 443 : 80;
	    }
	    ...
	    if (this.hasXDR()) {
	      ...
	      xhr.onreadystatechange = function () {
	        ...
	        if (200 === xhr.status || 1223 === xhr.status) {
	          ...
	          // make sure the `error` event handler that's _id-set
...
/***/ function(module, exports) {
	...
	/**
	 * Yeast: A tiny growing s_id generator.
	 *
	 * @returns {String} A unique s_id.
	 * @api public
	 */
	function yeast() {
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * These events can't be emitted by the _id.
	 *
	 * @api private
	 */
	...
	Socket.prototype.emit = function (ev) {
	  ...
	  if ('function' === typeof args[args.length - 1]) {
	    debug('emitting packet with ack s_id %d', this.ids);
